document.addEventListener('DOMContentLoaded', () => {
    ...
    analyzeBtn.addEventListener('click', async () => {
        ...
        try {
            const resp = await fetch('http://localhost:8000/analyze_pearson', {
                method: 'POST',
                body: formData
            });
    ...
    function setupDownloads(formData) {
        ...
        setupBtn('dl-doc-btn', 'report_pearson_doc', 'Pearson_Correlation_Report.docx');
        setupBtn('dl-excel-btn', 'report_pearson_excel', 'Pearson_Correlation_Output.xlsx');
    }
